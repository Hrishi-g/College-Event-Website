  ...
  return (
    <div className="card_main">
        ...
        <div className="card-body">
          ...
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSc7pIXSkoHkqjGCxEVr6cxdWihNzIOQ4iJqaJEy-ZsZL_oTaA/viewform" target="_blank" className="btn btn-primary">
            Participate
          </a>
        </div>
      </div>
      <div className="card" style={{width: "18rem"}}>
        ...
        <div className="card-body">
          ...
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSdlSNkXTl32eJ401IoWVSac_QHN-_O1vyfouKKE2OdLdkNqXw/viewform" target="_blank" className="btn btn-primary">
            Participate
          </a>
        </div>
      </div>
        ...
        <div className="card-body">
          ...
          <a href="https://docs.google.com/forms/d/e/1FAIpQLScpH-Oy73a6WN9S1T-cohWX_gKpSYXiRSrqCDYGTkYueq0iWA/viewform" target="_blank" className="btn btn-primary">
            Participate
          </a>
        </div>
      </div>
      <div className="card" style={{width: "18rem"}}>
        ...
        <div className="card-body">
          ...
          <a href="https://docs.google.com/forms/d/e/1FAIpQLScUZ1cnW3xtGs5zoSRuemp6d9EkdiPFj6fThbSshvVYuoDCGw/viewform" target="_blank" className="btn btn-primary">
            Participate
          </a>
        </div>
      </div>
